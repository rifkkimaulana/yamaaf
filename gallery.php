...
<section id="portfolio" class="portfolio">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>GALLERY</h2>
            <p>Melalui gallery, pengunjung dapat menjelajahi berbagai produk, layanan, atau karya seni dengan mudah.
            </p>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
            ...
            while ($data_produk = mysqli_fetch_assoc($result_produk)) {
                echo '<div class="col-lg-4 col-md-6 portfolio-item filter-' . $data_produk['kategori'] . '">';
